...
Namespace Migrations
    ...
    Public NotInheritable Partial Class initialsetup
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(initialsetup))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202310191120044_initial setup"
            End Get
        End Property
